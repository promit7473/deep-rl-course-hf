...
try:
    ...
    from sf_examples.vizdoom.doom.doom_utils import make_doom_env, doom_env_by_name
    from sf_examples.vizdoom.doom.wrappers.scenario_wrappers.gathering_rewards import DoomGatheringRewardWrapper
